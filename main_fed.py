...
from utils.show import show_dict_users, show_devices_info, show_devices_partition
...
from utils.sampling import mnist_iid, mnist_noniid, cifar_iid, cifar_noniid, semi_data_adjust
...
if __name__ == '__main__':
    ...
    plt.savefig('./main_fed_save/fed_seed{}_{}_{}_{}_C{}_iid{}.{}.loss.train.png'.format(args.seed, args.dataset, args.model, args.epochs, args.frac, args.iid, args.type))

    # plot acc curve
    plt.figure()
    plt.plot(range(len(acc_test_lst)), acc_test_lst)
    plt.ylabel('acc_test')
    plt.savefig('./main_fed_save/fed_seed{}_{}_{}_{}_C{}_iid{}.{}.acc.test.png'.format(args.seed, args.dataset, args.model, args.epochs, args.frac, args.iid, args.type))
    ...
    pickle.dump(record, open('./main_fed_save/fed_seed{}_{}_{}_{}_C{}_iid{}.{}.record'.format(args.seed, args.dataset, args.model, args.epochs, args.frac, args.iid, args.type), 'wb'))
