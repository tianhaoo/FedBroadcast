...
rects4 = ax.bar(x + width*0, random_choice_y_lst_csame, width, label='Broadcast-RandGroup', tick_label=x_lst, color=draw_args.randgroup_color)
rects4 = ax.bar(x + width*1, random_choice_y_lst_c5, width, label='Broadcast-RandSel', color=draw_args.randsel_color)
rects6 = ax.bar(x + width*2, opt_group_y_lst, width, label='Broadcast-OptGroup', color=draw_args.optgroup_color)

# Add some text for labels, title and custom x-axis tick labels, etc.
ax.set_ylabel('Downloading Latency (ms)', label_font)
ax.set_xlabel("Number of Total Devices", label_font)
ax.legend(prop=legend_font)
fig.tight_layout()
plt.savefig("C:\\Users\\tian\\Desktop\\figs\\{}_{}_1.pdf".format(args.dataset, args.R))
...
ax.legend(prop=legend_font)
fig.tight_layout()
plt.savefig("C:\\Users\\tian\\Desktop\\figs\\{}_{}_2.pdf".format(args.dataset, args.R))
