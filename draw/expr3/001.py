...
if __name__ == "__main__":
    ...
    fedavg_record_path_lst = [
        "fed_seed1_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
        "fed_seed2_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
        "fed_seed3_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
        "fed_seed4_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
        "fed_seed5_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
        "fed_seed6_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
        "fed_seed7_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
        "fed_seed8_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
        "fed_seed9_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
        "fed_seed10_mnist_mlp_1000_C0.1_iidTrue.fedAvg.record",
    ]
    group_record_path_lst = [
        "fed_seed1_mnist_mlp_1000_C0.1_iidTrue.group.record",
        "fed_seed2_mnist_mlp_1000_C0.1_iidTrue.group.record",
        "fed_seed3_mnist_mlp_1000_C0.1_iidTrue.group.record",
        "fed_seed4_mnist_mlp_1000_C0.1_iidTrue.group.record",
        "fed_seed5_mnist_mlp_1000_C0.1_iidTrue.group.record",
        "fed_seed6_mnist_mlp_1000_C0.1_iidTrue.group.record",
        "fed_seed7_mnist_mlp_1000_C0.1_iidTrue.group.record",
        "fed_seed8_mnist_mlp_1000_C0.1_iidTrue.group.record",
        "fed_seed9_mnist_mlp_1000_C0.1_iidTrue.group.record",
        "fed_seed10_mnist_mlp_1000_C0.1_iidTrue.group.record",
    ]
    root_path = "C:\\Users\\tian\PycharmProjects\\torch_FL\\main_fed_save"
    ...
    fedavg_acc_test_lst_min_lst = [i for i in fedavg_acc_test_lst_min_lst]
    fedavg_acc_test_lst_average_lst = [i for i in fedavg_acc_test_lst_average_lst]
    fedavg_acc_test_lst_max_lst = [i for i in fedavg_acc_test_lst_max_lst]
    ...
    ax.plot(random_choice_x_lst, signal.savgol_filter(fedavg_acc_test_lst_average_lst, 47, 3), label="FedAvg", linewidth=2)

    ax.fill_between(random_group_x_lst, group_acc_test_lst_min_lst, group_acc_test_lst_max_lst, alpha=0.3, linewidth=1)
    ax.plot(random_group_x_lst, signal.savgol_filter(group_acc_test_lst_average_lst, 47, 3), label="Round Robin", linewidth=2)

    ax.fill_between(opt_group_x_lst, group_acc_test_lst_min_lst, group_acc_test_lst_max_lst, alpha=0.3, linewidth=1)
    ax.plot(opt_group_x_lst, signal.savgol_filter(group_acc_test_lst_average_lst, 47, 3), label="FedBroadcast", linewidth=2)
